...
if x == 6:
    ...
    for i in range(1, 21):
        print('Running test data', i)
        com = 'time ./code < ComplexDataSet/testcase6/' + str(i) + '.in > ComplexDataSet/testcase6/my' + str(i) + '.out'
        os.system(com)
        com = 'diff ComplexDataSet/testcase6/' + str(i) + '.out ComplexDataSet/testcase6/my' + str(i) + '.out'
        os.system(com)